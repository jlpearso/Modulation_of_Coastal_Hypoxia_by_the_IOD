...
for vv = 1:length(vars)
    ...
    for pp = 1:length(doxy)
        ...
        elseif ~isempty(tmpvar(~isnan(tmpvar)))
...
if plot_fig == 1
    ...
    % save png
    outfn = ['Profile_qc_numbers_' num2str(qc_thresh)  '.png'];
    ...
    % save png
    outfn = ['Profile_qc_locations_' num2str(qc_thresh)  '.png'];
    print(gcf,[outfp outfn],'-dpng','-r300'); 
...
% save the data
save([outdp outfn],'-struct','struc','-v7.3');