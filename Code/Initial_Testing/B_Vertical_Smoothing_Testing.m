...
struc.TCD_grad = ave_pres(grad_temp_min_ind);
struc.OCD_grad = ave_pres(grad_doxy_min_ind);

struc.TCD_grad_sm_5 = ave_pres(grad_temp_min_ind_sm_5);
struc.OCD_grad_sm_5 = ave_pres(grad_doxy_min_ind_sm_5);

struc.TCD_grad_sm_10 = ave_pres(grad_temp_min_ind_sm_10);
struc.OCD_grad_sm_10 = ave_pres(grad_doxy_min_ind_sm_10);

struc.TCD_grad_sm_15 = ave_pres(grad_temp_min_ind_sm_15);
struc.OCD_grad_sm_15 = ave_pres(grad_doxy_min_ind_sm_15);

% set the places where there wasn't a minimum to NaN

struc.TCD_grad(isnan(grad_temp_min))=nan;
struc.OCD_grad(isnan(grad_doxy_min))=nan;

struc.TCD_grad_sm_5(isnan(grad_temp_min_sm_5))=nan;
struc.OCD_grad_sm_5(isnan(grad_doxy_min_sm_5))=nan;

struc.TCD_grad_sm_10(isnan(grad_temp_min_sm_10))=nan;
struc.OCD_grad_sm_10(isnan(grad_doxy_min_sm_10))=nan;

struc.TCD_grad_sm_15(isnan(grad_temp_min_sm_15))=nan;
struc.OCD_grad_sm_15(isnan(grad_doxy_min_sm_15))=nan;
...
A=accumarray( [latidx(:), lonidx(:)], struc.TCD_grad, [], @mean); %finds the # measurements in each grid
[Alon, Alat] = meshgrid(minlon:max(lon),minlat:max(lat));
...
m_proj('mercator','longitudes',[30,120], ...
           'latitudes',[-20,30]);
hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave); shading flat;
m_pcolor(Alon,Alat,A); shading flat;
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% oldcmap = colormap('jet');
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_5); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% oldcmap = colormap('jet');
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave_sm_5); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% oldcmap = colormap('jet');
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_10); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% oldcmap = colormap('jet');
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave_sm_10); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% oldcmap = colormap('jet');
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_15); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% ylabel(c,'TCD')
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave_sm_15); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% ylabel(c,'OCD')
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_5-struc.TCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% colormap(coolwarm);
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave_sm_5-struc.OCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% colormap(coolwarm);
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_10-struc.TCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% colormap(coolwarm);
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,lat_grid,struc.OCD_grad_grid_ave_sm_10-struc.OCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
% colormap(coolwarm);
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.TCD_grad_grid_ave_sm_15-struc.TCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
...
%            'latitudes',[-20,30]);
% hold on
% m_pcolor(struc.lon_grid,struc.lat_grid,struc.OCD_grad_grid_ave_sm_15-struc.OCD_grad_grid_ave); shading flat;
% m_coast('patch',[.7 .7 .7],'edgecolor','none');
% m_grid('background color','k');
% c = colorbar;
