...
% such sets of colors are garish and confusing: restricting the lightness
% and chroma ranges provides much more pleasant sets of distinct colors
% (see the last section "Interactive Tool" for an example). Printing the
% colors also requires the lightness and chroma ranges to be restricted
...
% together with |MAXDISTCOLOR| and converts from sRGB to the slightly 
...
clf('reset')
rgb = maxdistcolor(64,@sRGB_to_Lab, 'bitR',2,'bitG',2,'bitB',2, 'exc',[]);
