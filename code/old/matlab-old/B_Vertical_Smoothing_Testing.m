...
struc.TCD(struc.TCD>=pres_thresh) = nan;
struc.OCD(struc.OCD>=pres_thresh) = nan;

struc.TCD_sm_5(struc.TCD_sm_5>=pres_thresh) = nan;
struc.OCD_sm_5(struc.OCD_sm_5>=pres_thresh) = nan;

struc.TCD_sm_10(struc.TCD_sm_10>=pres_thresh) = nan;
struc.OCD_sm_10(struc.OCD_sm_10>=pres_thresh) = nan;

struc.TCD_sm_15(struc.TCD_sm_15>=pres_thresh) = nan;
struc.OCD_sm_15(struc.OCD_sm_15>=pres_thresh) = nan;
