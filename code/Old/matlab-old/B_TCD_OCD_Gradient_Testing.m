...
% MEAN
subaxis(1,3,1, 'Spacing', 0.03, 'Padding', 0.03, 'MR', 0.03,'ML', 0.03,'MB', 0.05,'MT', 0.05);

% bottom x axis
plot(mean_grad_doxy_box_N,-1*ave_pres(:,1),'k','linewidth',3);
...
line(mean_doxy_box_N,-1*pres,'Parent',ax2,'Color','r','linewidth',5);
xlims = xlim;
x = xlims(1):xlims(2); y = ones(size(x));
line(x,-1*mean_OCD_box_N.*y,'Parent',ax2,'linewidth',3,'Color','k', 'linestyle',':');
...
% Profiles
subaxis(1,3,2, 'Spacing', 0.03, 'Padding', 0.03, 'MR', 0.03,'ML', 0.03,'MB', 0.05,'MT', 0.05);

% bottom x axis
plot(grad_doxy_box_N,-1*ave_pres(:,1),'k','linewidth',1);
ax1 = gca; % current axes
...
line(doxy_box_N,-1*pres,'Parent',ax2,'Color','r','linewidth',1);
xlims = xlim;
x = xlims(1):xlims(2); y = ones(size(x));
line(x,-1*OCD_box_N.*y,'Parent',ax2,'linewidth',1,'Color','k', 'linestyle',':');
...
m_latlon_boundbox(latlon_lim_box_N,'Edgecolor','w','Linewidth',3)
...
% % Plot Temperature ========================================================
% 
% subaxis(2,2,2, 'Spacing', 0.03, 'Padding', 0.03, 'MR', 0.03,'ML', 0.03,'MB', 0.05,'MT', 0.05);
